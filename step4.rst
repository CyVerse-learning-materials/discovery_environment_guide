...
1. Open the **Analyses** view by clicking on |analyses icon| on the left sidebar of the DE interface to monitor the status of your submitted analysis. The analysis launched most recently will be at the top of the list.
...
5. To open and view the output folder of a completed analysis, click on the output folder icon |output folder icon| at the right side of that particular analysis.
